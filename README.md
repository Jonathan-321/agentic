...
## Eval Results — Memory Mode Ablation

<p align="center">
  <img src="assets/needle_heatmap.png" alt="Needle-in-Haystack: Pass Rate by Context Size and Memory Mode" width="800"/>
</p>

> Chunked vector retrieval fully recovers needle-in-haystack performance on documents over 5,000 words, while summary-only memory provides zero benefit at any context size.

## Architecture

<p align="center">
  <img src="assets/architecture.png" alt="ReAct Agent Architecture with Memory Modes" width="850"/>
</p>

## Demo — Interactive Mode

<p align="center">
  <img src="docs/demo_1.png" alt="Demo output" width="100%"/>
</p>

<p align="center">
  <img src="docs/demo_2.png" alt="Demo output (continued)" width="100%"/>
</p>

## Full Eval Heatmap

<p align="center">
  <img src="docs/demo.png" alt="Demo output" width="100%"/>
</p>
